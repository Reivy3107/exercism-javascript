...
const areSetsEqual = (setA, setB) => setA.size === setB.size && [...setA].every((val) => setB.has(val));
...
describe('Anagram', () => {
  ...
  test('detects anagram', () => {
    ...
    const actual = findAnagrams('listen', ['enlists', 'google', 'inlets', 'banana']);
    expect(areSetsEqual(new Set(expected), new Set(actual))).toEqual(true);
  });

  test('detects three anagrams', () => {
    const expected = ['gallery', 'regally', 'largely'];
    const actual = findAnagrams('allergy', ['gallery', 'ballerina', 'regally', 'clergy', 'largely', 'leading']);
    expect(areSetsEqual(new Set(expected), new Set(actual))).toEqual(true);
  });
  ...
  test('detects anagrams case-insensitively', () => {
    ...
    const actual = findAnagrams('Orchestra', ['cashregister', 'Carthorse', 'radishes']);
    expect(areSetsEqual(new Set(expected), new Set(actual))).toEqual(true);
  });
